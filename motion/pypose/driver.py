...
class Driver:
    ...
    def __init__(self, port="/dev/tty.usbserial-AR0JW21B",baud=38400, interpolation=False, direct=False, verbose=False):
    ...
    def getPacket(self, mode, id=-1, leng=-1, error=-1, params = None):
        ...
        #time.sleep()  # with the port open, the response will be buffered
